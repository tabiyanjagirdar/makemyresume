...
import resumebro from './assets/resumebro.png'; // Assuming you have a logo image
import {
  FaInstagram,
  FaWhatsapp,
  FaEnvelope,
...
const App = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col scroll-smooth bg-white text-gray-900">
      ...
      <header className="w-full shadow-lg relative bg-white">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <img
            src={resumebro}
            alt="ResumeBro Logo"
            className="h-12 md:h-16 w-auto object-contain" onClick={'#home'}
          />
      ...
      <section
        id="contact"
        className="w-full px-4 py-12 flex justify-center items-center bg-white text-gray-900"
      >
        <div className="bg-white border border-gray-300 rounded-lg p-6 sm:p-8 max-w-4xl w-full text-center space-y-6">
          ...
          <div className="flex justify-center items-center gap-8 overflow-x-auto whitespace-nowrap">
            ...
            {/* <a
        href="tel:+919964198118"
        className="p-3 rounded-full border-2 border-black text-gray-700 hover:scale-110 transition"
        aria-label="Call Us"
      >
